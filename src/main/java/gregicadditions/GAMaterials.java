...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final long GENERATE_METAL_CASING = createFlag(53);
    ...
    static long EXT2_METAL = GENERATE_PLATE | GENERATE_DENSE | GENERATE_ROD | GENERATE_BOLT_SCREW | GENERATE_GEAR | GENERATE_FOIL | GENERATE_FINE_WIRE | GENERATE_LONG_ROD | GENERATE_DOUBLE_PLATE;
    ...
    public static final IngotMaterial Zirconium = new IngotMaterial(912, "zirconium", 0xE0E1E1, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL, Zr);
    ...
    public static final RadioactiveMaterial Protactinium = new RadioactiveMaterial(824, "protactinium", 0xA78B6D, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Pa, 0, 0, 0, 0);
    public static final RadioactiveMaterial UraniumRadioactive = new RadioactiveMaterial(822, "uranium_radioactive", Uranium.materialRGB, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_ORE | GENERATE_FRAME, U, 0, 0, 0, 0);
    public static final RadioactiveMaterial Neptunium = new RadioactiveMaterial(818, "neptunium", 0x284D7B, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Np, 0, 0, 0, 0);
    public static final RadioactiveMaterial PlutoniumRadioactive = new RadioactiveMaterial(814, "plutonium_radioactive", Plutonium.materialRGB, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Pu, 0, 0, 0, 0);
    public static final RadioactiveMaterial Curium = new RadioactiveMaterial(807, "curium", 0x7B544E, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Cm, 0, 0, 0, 0);
    public static final RadioactiveMaterial Berkelium = new RadioactiveMaterial(801, "berkelium", 0x645A88, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Bk, 0, 0, 0, 0);
    public static final RadioactiveMaterial Californium = new RadioactiveMaterial(797, "californium", 0xA85A12, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Cf, 0, 0, 0, 0);
    public static final RadioactiveMaterial Einsteinium = new RadioactiveMaterial(791, "einsteinium", 0xCE9F00, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Es, 0, 0, 0, 0);
    public static final RadioactiveMaterial Fermium = new RadioactiveMaterial(786, "fermium", 0x984ACF, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Fm, 0, 0, 0, 0);
    public static final RadioactiveMaterial Mendelevium = new RadioactiveMaterial(780, "mendelevium", 0x1D4ACF, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_FRAME, Md, 0, 0, 0, 0);
    ...
    public static final FluidMaterial IronChloride = new FluidMaterial(978, "iron_chloride", 0x060b0b, MaterialIconSet.FLUID, ImmutableList.of(new MaterialStack(Iron, 1), new MaterialStack(Chlorine, 3)), DISABLE_DECOMPOSITION);
    ...
    public static final FluidMaterial Naphthalene = new FluidMaterial(924, "naphtalene", 0xFFFFFF, MaterialIconSet.FLUID, of(new MaterialStack(Carbon, 10), new MaterialStack(Hydrogen, 8)), NO_RECYCLING | GENERATE_FLUID_BLOCK | DISABLE_DECOMPOSITION);
    ...
    public static final FluidMaterial SodiumFormate = new FluidMaterial(891, "sodium_formate", 0xFFAAAA, MaterialIconSet.FLUID, of(new MaterialStack(Hydrogen, 1), new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Sodium, 1)), DISABLE_DECOMPOSITION);
    ...
    public static final FluidMaterial OsmiumSolution = new FluidMaterial(873, "osmium_solution", (Osmium.materialRGB + Water.materialRGB)/2, MaterialIconSet.FLUID, of(new MaterialStack(Osmium, 1), new MaterialStack(Oxygen, 4), new MaterialStack(Water, 1)), DISABLE_DECOMPOSITION);
    public static final FluidMaterial AcidicOsmiumSolution = new FluidMaterial(875, "acidic_osmium_solution", OsmiumSolution.materialRGB-20, MaterialIconSet.FLUID, of(new MaterialStack(Osmium, 1), new MaterialStack(Oxygen, 4), new MaterialStack(Water, 1), new MaterialStack(HydrochloricAcid, 1)), DISABLE_DECOMPOSITION);
    public static final DustMaterial IridiumDioxide = new DustMaterial(874, "iridium_dioxide", (Iridium.materialRGB + Oxygen.materialRGB)/2, MaterialIconSet.DULL, 0, of(new MaterialStack(Iridium, 1), new MaterialStack(Oxygen, 2)), EXCLUDE_BLOCK_CRAFTING_RECIPES | SMELT_INTO_FLUID | DISABLE_DECOMPOSITION);
    public static final FluidMaterial AcidicIridiumSolution = new FluidMaterial(872, "acidic_iridium_solution", IridiumDioxide.materialRGB-20, MaterialIconSet.FLUID, of(new MaterialStack(HydrochloricAcid, 2), new MaterialStack(IridiumDioxide, 2)), DISABLE_DECOMPOSITION);
    ...
    public static final DustMaterial Triniite = new DustMaterial(836,"triniite",0x5F5A76, MaterialIconSet.SHINY, 7, of(new MaterialStack(Trinium, 3), new MaterialStack(Actinium, 3), new MaterialStack(Selenium, 4), new MaterialStack(Astatine, 4)), GENERATE_ORE | DISABLE_DECOMPOSITION);
    ...
    public static final DustMaterial OrganicFertilizer = new DustMaterial(754, "organic_fertilizer", 0xDDDDDD, MaterialIconSet.SHINY, 2, of(new MaterialStack(Calcium, 5), new MaterialStack(Phosphate, 3), new MaterialStack(Hydrogen, 1), new MaterialStack(Oxygen, 1)), DISABLE_DECOMPOSITION);
    ...
    public static final GemMaterial Zircon = new GemMaterial(713, "zircon", 0xeb9e3f, MaterialIconSet.GEM_VERTICAL, 3, of(new MaterialStack(Zirconium, 1), new MaterialStack(Silicon, 1), new MaterialStack(Oxygen, 4)), GENERATE_ORE | DISABLE_DECOMPOSITION);
    public static final GemMaterial LeadZirconateTitanate = new GemMaterial(696, "lead_zirconate_titanate", 0x359ade, MaterialIconSet.OPAL, 3, of(new MaterialStack(Lead, 1), new MaterialStack(Zirconium, 1), new MaterialStack(Titanium, 1), new MaterialStack(Oxygen, 3)), GENERATE_PLATE | DISABLE_DECOMPOSITION);
    ...
    // INGOT MATERIALS
    public static final IngotMaterial EglinSteel = new IngotMaterial(989, "eglin_steel", 0x8B4513, MaterialIconSet.METALLIC, 6, ImmutableList.of(new MaterialStack(GAMaterials.EglinSteelBase, 10), new MaterialStack(Sulfur, 1), new MaterialStack(Silicon, 1), new MaterialStack(Carbon, 1)), EXT2_METAL | GENERATE_FRAME, null, 1048);
    public static final IngotMaterial Grisium = new IngotMaterial(987, "grisium", 0x355D6A, MaterialIconSet.METALLIC, 6, ImmutableList.of(new MaterialStack(Titanium, 9), new MaterialStack(Carbon, 9), new MaterialStack(Potassium, 9), new MaterialStack(Lithium, 9), new MaterialStack(Sulfur, 9), new MaterialStack(Hydrogen, 5)), EXT2_METAL | GENERATE_FRAME, null, 3850);
    public static final IngotMaterial Inconel625 = new IngotMaterial(986, "inconel_a", 0x80C880, MaterialIconSet.METALLIC, 6, ImmutableList.of(new MaterialStack(Nickel, 3), new MaterialStack(Chrome, 7), new MaterialStack(Molybdenum, 10), new MaterialStack(Invar, 10), new MaterialStack(Nichrome, 13)), EXT2_METAL | GENERATE_FRAME, null, 2425);
    public static final IngotMaterial MaragingSteel250 = new IngotMaterial(985, "maraging_steel_a", 0x92918D, MaterialIconSet.METALLIC, 6, ImmutableList.of(new MaterialStack(Steel, 16), new MaterialStack(Molybdenum, 1), new MaterialStack(Titanium, 1), new MaterialStack(Nickel, 4), new MaterialStack(Cobalt, 2)), EXT2_METAL | GENERATE_FRAME, null, 2413);
    public static final IngotMaterial Potin = new IngotMaterial(984, "potin", 0xC99781, MaterialIconSet.METALLIC, 6, ImmutableList.of(new MaterialStack(Lead, 2), new MaterialStack(Bronze, 2), new MaterialStack(Tin, 1)), EXT2_METAL | GENERATE_FRAME, null);
    public static final IngotMaterial Staballoy = new IngotMaterial(983, "staballoy", 0x444B42, MaterialIconSet.METALLIC, 6, ImmutableList.of(new MaterialStack(Uranium, 9), new MaterialStack(Titanium, 1)), EXT2_METAL | GENERATE_FRAME | DISABLE_DECOMPOSITION, null, 3450);
    ...
    public static final IngotMaterial Tumbaga = new IngotMaterial(981, "tumbaga", 0xFFB20F, MaterialIconSet.METALLIC, 6, ImmutableList.of(new MaterialStack(Gold, 7), new MaterialStack(Bronze, 3)), EXT2_METAL | GENERATE_FRAME, null, 1200);
    public static final IngotMaterial Stellite = new IngotMaterial(980, "stellite", 0x9991A5, MaterialIconSet.METALLIC, 6, ImmutableList.of(new MaterialStack(Cobalt, 9), new MaterialStack(Chrome, 9), new MaterialStack(Manganese, 5), new MaterialStack(Titanium, 2)), EXT2_METAL | GENERATE_FRAME, null, 4310);
    public static final IngotMaterial Talonite = new IngotMaterial(979, "talonite", 0x9991A5, MaterialIconSet.SHINY, 6, ImmutableList.of(new MaterialStack(Cobalt, 4), new MaterialStack(Chrome, 3), new MaterialStack(Phosphorus, 2), new MaterialStack(Molybdenum, 1)), EXT2_METAL | GENERATE_FRAME, null, 3454);
    ...
    public static final IngotMaterial Nitinol60 = new IngotMaterial(943, "nitinol_a", 0xCCB0EC, MaterialIconSet.METALLIC, 4, ImmutableList.of(new MaterialStack(Nickel, 2), new MaterialStack(Titanium, 3)), EXT2_METAL | GENERATE_FRAME, null, Titanium.blastFurnaceTemperature);
    public static final IngotMaterial BabbittAlloy = new IngotMaterial(942, "babbitt_alloy", 0xA19CA4, MaterialIconSet.METALLIC, 4, ImmutableList.of(new MaterialStack(Tin, 5), new MaterialStack(Lead, 36), new MaterialStack(Antimony, 8), new MaterialStack(Arsenic, 1)), EXT2_METAL | GENERATE_FRAME, null, 737);
    ...
    public static final IngotMaterial IncoloyMA956 = new IngotMaterial(940, "incoloy_ma", 0xAABEBB, MaterialIconSet.METALLIC, 4, ImmutableList.of(new MaterialStack(Iron, 16), new MaterialStack(Aluminium, 3), new MaterialStack(Chrome, 5), new MaterialStack(Yttrium, 1)), EXT2_METAL | GENERATE_FRAME | DISABLE_AUTOGENERATED_MIXER_RECIPE, null, 5325);
    public static final IngotMaterial ZirconiumCarbide = new IngotMaterial(905, "zirconium_carbide", 0xFFDACD, MaterialIconSet.SHINY, 2, of(new MaterialStack(Zirconium, 1), new MaterialStack(Carbon, 1)), EXT2_METAL | GENERATE_FRAME, null, 1200);
    ...
    public static final IngotMaterial Ruridit = new IngotMaterial(858, "ruridit", 0xA4A4A4, MaterialIconSet.METALLIC, 2, of(new MaterialStack(Ruthenium, 2), new MaterialStack(Iridium, 1)), CORE_METAL, null, 8900);
    ...
    public static final IngotMaterial CarbonNanotubes = new IngotMaterial(709, "carbon_nanotubes", 0x2c2c2c, MaterialIconSet.SHINY, 5, of(new MaterialStack(Carbon, 1)), EXCLUDE_BLOCK_CRAFTING_RECIPES | SMELT_INTO_FLUID | GENERATE_FOIL | DISABLE_DECOMPOSITION | GENERATE_FINE_WIRE, null);
    ...
    public static final IngotMaterial ProtoAdamantium = new IngotMaterial(716, "proto_adamantium", 0x4662d4, MaterialIconSet.SHINY, 7, of(new MaterialStack(Adamantium, 3), new MaterialStack(Promethium, 2)), CORE_METAL, null, 11244);
    public static final IngotMaterial TriniumTitanium = new IngotMaterial(715, "trinium_titanium", 0x9986a3, MaterialIconSet.SHINY, 7, of(new MaterialStack(Trinium, 2), new MaterialStack(Titanium, 1)), CORE_METAL, null, 11000);
    ...
    public static final SimpleFluidMaterial RareEarthHydroxidesSolution = new SimpleFluidMaterial("rare_earth_hydroxides_solution", 0xcfb37d, "NaOH(H2O)?(OH)3");
    public static final SimpleFluidMaterial RareEarthChloridesSolution = new SimpleFluidMaterial("rare_earth_chlorides_solution", 0x164b45, "(?Cl3)H2O");
    ...
    public static final SimpleFluidMaterial B27Supplement = new SimpleFluidMaterial("b27_supplement", 0x386939, "C142H230N36O44S");
    ...
    public static final SimpleFluidMaterial CalicheIodateBrine = new SimpleFluidMaterial("caliche_iodate_brine", 0xffe6660, "(H2O)NaNO3KNO3KClNaIO3");
    public static final SimpleFluidMaterial IodideSolution = new SimpleFluidMaterial("iodide_solution", 0x08081c, "(H2O)NaNO3KNO3KClNaI");
    public static final SimpleFluidMaterial CalicheNitrateSolution = new SimpleFluidMaterial("caliche_nitrate_solution", 0xffe6660, "(H2O)NaNO3KNO3KClNaOH");
    public static final SimpleFluidMaterial CalicheIodineBrine = new SimpleFluidMaterial("caliche_iodine_brine", 0xffe6660, "(H2O)NaNO3KNO3KClNaOHI");
    ...
    public static final SimpleFluidMaterial HydroxylamineDisulfate = new SimpleFluidMaterial("hydroxylamine_disulfate", 0x99add6, "(NH3OH)2(NH4)2(SO4)2");
    public static final SimpleFluidMaterial Hydroxylamine = new SimpleFluidMaterial("hydroxylamine", 0x99cc99, "H3NO");
    public static final SimpleFluidMaterial Amidoxime = new SimpleFluidMaterial("amidoxime", 0x66ff33, "H3N2O(CH)");
    ...
    public static final SimpleFluidMaterial Mercaptophenol = new SimpleFluidMaterial("mercaptophenol", 0xbaaf18, "C6H6OS");
    ...
    public static final SimpleFluidMaterial TrimethyltinChloride = new SimpleFluidMaterial("trimethyltin_chloride", 0x8c8075, "(CH3)3SnCl");
    ...
    public static final SimpleFluidMaterial TitaniumTetrafluoride = new SimpleFluidMaterial("titanium_tetrafluoride", Titanium.materialRGB);
    public static final SimpleFluidMaterial Titanium50Tetrafluoride = new SimpleFluidMaterial("titanium50_tetrafluoride", Titanium.materialRGB);
    ...
    public static final SimpleFluidMaterial SeleniteTelluriteMix = new SimpleFluidMaterial("selenite_tellurite_mixture", 0x765A30, "TeO2SeO2(Na2CO3)2");
    public static final SimpleFluidMaterial SeleniteSolution = new SimpleFluidMaterial("selenite_solution", 0xc1c46a, "Na2SeO3");
    ...
    public static final SimpleFluidMaterial PureAluminiumHydroxideSolution = new SimpleFluidMaterial("pure_aloh3_soution", (Aluminium.materialRGB+Oxygen.materialRGB+ Hydrogen.materialRGB+40)/2, "(H2O)Al2(OH)6");
    ...
    public static final SimpleFluidMaterial TitanylSulfate = new SimpleFluidMaterial("titanyl_sulfate", 0xdc3d7c, "TiO(SO4)");
    ...
    public static final SimpleFluidMaterial Diethoxythiophene = new SimpleFluidMaterial("dietoxythiophene", 0x90ff43, "C4H2(OC2H5)2S");
    ...
    public static final SimpleFluidMaterial Glycine = new SimpleFluidMaterial("glycine", (Ethylenediamine.rgb+Formaldehyde.rgb)/2, "NH2CH2COOH");
    ...
    public static final SimpleFluidMaterial AmmoniumFluoride = new SimpleFluidMaterial("ammonium_fluoride",AmmoniumChloride.materialRGB, "NH4F");
    ...
    public static final SimpleFluidMaterial ChlorousAcid = new SimpleFluidMaterial("chlorous_acid", 0x2d6e8a, "HClO2"); // TODO USELESS, REMOVE
    ...
    public static final SimpleFluidMaterial TetrafluoroboricAcid = new SimpleFluidMaterial("tetrafluoroboric_acid",Silvertetrafluoroborate.rgb,"HBF4");
    public static final SimpleFluidMaterial BoronTrifluorideEtherate = new SimpleFluidMaterial("boron_trifluoride_etherate", (BoronFluoride.rgb+Diethylether.rgb)/2, "(BF3)(C2H5)2O");
    public static final SimpleFluidMaterial BoraneDimethylsulfide = new SimpleFluidMaterial("borane_dimethylsulfide", (Diborane.rgb+Dimethylsulfide.rgb)/2, "(BH3)(CH3)2S");
    public static final SimpleFluidMaterial Perfluorobenzene = new SimpleFluidMaterial("perfluorobenzene", 0x226E22, "C6F6");
    public static final SimpleFluidMaterial NitratedTriniiteSolution = new SimpleFluidMaterial("nitrated_triniite_solution", 0x428c9f);
    public static final SimpleFluidMaterial ResidualTriniiteSolution = new SimpleFluidMaterial("residual_triniite_solution", 0x219daf);
    public static final SimpleFluidMaterial HeavilyFluorinatedTriniumSolution = new SimpleFluidMaterial("heavily_fluorinated_trinium_solution", 0x348d41);
    ...
    public static final SimpleFluidMaterial EthylTrifluoroacetate = new SimpleFluidMaterial("ethyl_trifluoroacetate", 0x88a12d, "C4H5F3O2");
    public static final SimpleFluidMaterial Acetothienone = new SimpleFluidMaterial("acetothieone", 0x79882a, "C6H6SO");
    public static final SimpleFluidMaterial TheonylTrifluoroacetate = new SimpleFluidMaterial("theonyl_trifluoroacetate",0x88882b, "C8H5F3O2S");
    public static final SimpleFluidMaterial ActiniumRadiumNitrateSolution = new SimpleFluidMaterial("actinium_radium_nitrate_solution", 0xd2f0df);
    public static final SimpleFluidMaterial ActiniumRadiumHydroxideSolution = new SimpleFluidMaterial("actinium_radium_hydroxide_solution", 0xe2f5ef);
    ...
    public static final SimpleFluidMaterial OxidizedResidualSolution = new SimpleFluidMaterial("oxidized_residual_solution", 0x23ad7f);
    ...
    public static final SimpleFluidMaterial TaraniumDepletedHeliumPlasma = new SimpleFluidMaterial("taranium_depleted_helium_plasma", Helium.materialRGB/2+Taranium.materialRGB/2, 10000);
    ...
    public static final SimpleFluidMaterial LiquidFluorine = new SimpleFluidMaterial("liquid_fluorine",Fluorine.materialRGB-0x303030);
    public static final SimpleFluidMaterial LiquidXenon = new SimpleFluidMaterial("liquid_xenon",Xenon.materialRGB, 165);
    ...
    public static final SimpleDustMaterial Yeast = new SimpleDustMaterial("yeast", 0xf0e660, (short) 26, MaterialIconSet.ROUGH, "???");
    ...
    public static final SimpleDustMaterial SilicaGel = new SimpleDustMaterial("silica_gel", 0x61daff, (short) 28, MaterialIconSet.SHINY, "SiO2");
    public static final SimpleDustMaterial SilicaAluminaGel = new SimpleDustMaterial("silica_alumina_gel", 0x558d9e, (short) 29, MaterialIconSet.ROUGH, "Al2O3SiO2");
    public static final SimpleDustMaterial ZeoliteSievingPellets = new SimpleDustMaterial("zeolite_sieving_pellets", 0xa17bd1, (short) 30, MaterialIconSet.ROUGH, "Al2O3SiO2");
    public static final SimpleDustMaterial WetZeoliteSievingPellets = new SimpleDustMaterial("wet_zeolite_sieving_pellets", 0x392f45, (short) 31, MaterialIconSet.METALLIC, "Al2O3SiO2?");
    public static final SimpleDustMaterial GreenAlgae = new SimpleDustMaterial("green_algae", 0x228b22, (short) 32, MaterialIconSet.METALLIC, "An Algae");
    public static final SimpleDustMaterial BrownAlgae = new SimpleDustMaterial("brown_algae", 0xa52a2a, (short) 33, MaterialIconSet.METALLIC, "An Algae");
    public static final SimpleDustMaterial RedAlgae = new SimpleDustMaterial("red_algae", 0xf08080, (short) 34, MaterialIconSet.METALLIC, "An Algae");
    public static final SimpleDustMaterial DryRedAlgae = new SimpleDustMaterial("dry_red_algae", 0xff7f50, (short) 35, MaterialIconSet.ROUGH, "A Dry Algae");
    public static final SimpleDustMaterial RedAlgaePowder = new SimpleDustMaterial("red_algae_powder", 0xcc2f2f, (short) 36, MaterialIconSet.ROUGH, "A Powdered Algae");
    public static final SimpleDustMaterial PreFreezeAgar = new SimpleDustMaterial("pre_freeze_agar", 0x132b0d, (short) 37, MaterialIconSet.ROUGH, "Warm Agar");
    public static final SimpleDustMaterial FrozenAgarCrystals = new SimpleDustMaterial("frozen_agar_crystals", 0x68db4b, (short) 38, MaterialIconSet.SHINY, "Cold Agar");
    public static final SimpleDustMaterial Agar = new SimpleDustMaterial("agar", 0x38a31d, (short) 39, MaterialIconSet.DULL, "Agar");
    public static final SimpleDustMaterial BrevibacteriumFlavium = new SimpleDustMaterial("brevibacterium_flavium", 0x2c4d24, (short) 40, MaterialIconSet.ROUGH, "Bacteria");
    public static final SimpleDustMaterial StreptococcusPyogenes = new SimpleDustMaterial("streptococcus_pyogenes", 0x1c3b15, (short) 41, MaterialIconSet.ROUGH, "Bacteria");
    public static final SimpleDustMaterial EschericiaColi = new SimpleDustMaterial("eschericia_coli", 0x2d4228, (short) 42, MaterialIconSet.ROUGH, "Bacteria");
    public static final SimpleDustMaterial BifidobacteriumBreve = new SimpleDustMaterial("bifidobacterium_breve", 0x377528, (short) 43, MaterialIconSet.ROUGH, "Bacteria");
    public static final SimpleDustMaterial Alumina = new SimpleDustMaterial("alumina", 0x0b585c, (short) 44, MaterialIconSet.ROUGH, "Al2O3");
    public static final SimpleDustMaterial CupriavidusNecator = new SimpleDustMaterial("cupriavidus_necator", 0x22704f, (short) 46, MaterialIconSet.ROUGH, "Bacteria");
    public static final SimpleDustMaterial Shewanella = new SimpleDustMaterial("shewanella", 0x8752ab, (short) 47, MaterialIconSet.METALLIC, "Bacteria");
    ...
    public static final SimpleDustMaterial ZirconiumTetrafluoride = new SimpleDustMaterial("zirconium_tetrafluoride", (Zirconium.materialRGB+Fluorine.materialRGB)/2, (short) 56, MaterialIconSet.SHINY, "ZrF4");
    public static final SimpleDustMaterial BariumDifluoride = new SimpleDustMaterial("barium_difluoride", (Barium.materialRGB+Fluorine.materialRGB)/2, (short) 57, MaterialIconSet.METALLIC, "BaF2");
    public static final SimpleDustMaterial LanthanumTrifluoride = new SimpleDustMaterial("lanthanum_trifluoride", (Lanthanum.materialRGB+Fluorine.materialRGB)/2, (short) 58, MaterialIconSet.METALLIC, "LaF3");
    public static final SimpleDustMaterial AluminiumTrifluoride = new SimpleDustMaterial("aluminium_trifluoride", (Aluminium.materialRGB+Fluorine.materialRGB)/2, (short) 59, MaterialIconSet.ROUGH, "AlF3");
    public static final SimpleDustMaterial ErbiumTrifluoride = new SimpleDustMaterial("erbium_trifluoride", (Erbium.materialRGB+Fluorine.materialRGB)/2, (short) 60, MaterialIconSet.ROUGH, "ErF3");
    public static final SimpleDustMaterial ZBLANDust = new SimpleDustMaterial("zblan_dust", (ZirconiumTetrafluoride.rgb+BariumDifluoride.rgb+LanthanumTrifluoride.rgb+AluminiumTrifluoride.rgb)/4, (short) 61, MaterialIconSet.SHINY, "(ZrF4)18(BaF2)7(LaF3)2(AlF3)(NaF)7");
    public static final SimpleDustMaterial ErbiumDopedZBLANDust = new SimpleDustMaterial("erbium_doped_zblan_dust", (ZBLANDust.rgb+ErbiumTrifluoride.rgb)/2, (short) 62, MaterialIconSet.SHINY, "(ErF3)(ZrF4)18(BaF2)7(LaF3)2(AlF3)(NaF)7");
    public static final SimpleDustMaterial PotassiumCyanide = new SimpleDustMaterial("potassium_cyanide", (Potassium.materialRGB+Nitrogen.materialRGB)/2, (short) 63, MaterialIconSet.ROUGH, "KCN");
    public static final SimpleDustMaterial SuccinicAcid = new SimpleDustMaterial("succinic_acid", (MaleicAnhydride.rgb+Water.materialRGB+Hydrogen.materialRGB)/3, (short) 64, MaterialIconSet.ROUGH, "C4H6O4");
    public static final SimpleDustMaterial Succinimide = new SimpleDustMaterial("succinimide", (SuccinicAcid.rgb+Ammonia.materialRGB)/2, (short) 65, MaterialIconSet.METALLIC, "C4H5NO2");
    public static final SimpleDustMaterial Bromosuccinimide = new SimpleDustMaterial("bromo_succinimide", (Succinimide.rgb+Bromine.materialRGB)/2, (short) 66, MaterialIconSet.METALLIC, "C4H4BrNO2");
    public static final SimpleDustMaterial Benzophenanthrenylacetonitrile = new SimpleDustMaterial("benzophenanthrenylacetonitrile", (Naphthaldehyde.rgb+Ethylene.materialRGB-20)/2, (short) 67, MaterialIconSet.ROUGH, "C20H13N");
    ...
    public static final SimpleDustMaterial Fullerene = new SimpleDustMaterial("fullerene", (UnfoldedFullerene.rgb-20), (short) 69, MaterialIconSet.METALLIC, "C60");
    ...
    public static final SimpleDustMaterial Dimethylaminopyridine = new SimpleDustMaterial("dimethylaminopyridine", (Dimethylamine.materialRGB+Pyridine.rgb)/2, (short) 71, MaterialIconSet.ROUGH, "(CH3)2NC5H4N");
    public static final SimpleDustMaterial PdIrReOCeOS = new SimpleDustMaterial("pdirreoceos", (Palladium.materialRGB+Iridium.materialRGB+Rhenium.materialRGB+Cerium.materialRGB+Osmium.materialRGB+Silicon.materialRGB+Oxygen.materialRGB)/7, (short) 72, MaterialIconSet.SHINY, "PdIrReCeOsSiO4");
    public static final SimpleDustMaterial SodiumEthoxide = new SimpleDustMaterial("sodium_ethoxide", (Ethanol.materialRGB+ SodiumHydroxide.materialRGB)/2, (short) 73, MaterialIconSet.METALLIC, "C2H5ONa");
    public static final SimpleDustMaterial MgClBromide = new SimpleDustMaterial("mgcl_bromide", (MagnesiumChloride.materialRGB+Bromine.materialRGB)/2, (short) 74, MaterialIconSet.ROUGH, "MgClBr");
    public static final SimpleDustMaterial Sarcosine = new SimpleDustMaterial("sarcosine", (Glycine.rgb+Oxygen.materialRGB)/2, (short) 75, MaterialIconSet.SHINY, "C3H7NO2");
    public static final SimpleDustMaterial SodiumNitrite = new SimpleDustMaterial("sodium_nitrite", (Sodium.materialRGB+Nitrogen.materialRGB)/2, (short) 76, MaterialIconSet.ROUGH, "NaNO2");
    public static final SimpleDustMaterial ZnFeAlClCatalyst = new SimpleDustMaterial("znfealcl_catalyst", (Zinc.materialRGB+Iron.materialRGB+Aluminium.materialRGB+Chlorine.materialRGB)/4, (short) 77, MaterialIconSet.METALLIC, "ZnFeAlCl");
    ...
    public static final SimpleDustMaterial PdFullereneMatrix = new SimpleDustMaterial("pd_fullerene_matrix", (Palladium.materialRGB+Fullerene.rgb)/2, (short) 80, MaterialIconSet.SHINY, "PdC73H15NFe");
    public static final SimpleDustMaterial Terephthalaldehyde = new SimpleDustMaterial("terephthalaldehyde", (Dibromomethylbenzene.rgb+SulfuricAcid.materialRGB)/2, (short) 81, MaterialIconSet.FINE, "C8H6O2");
    public static final SimpleDustMaterial PreZylon = new SimpleDustMaterial("pre_zylon", (Terephthalaldehyde.rgb+Dinitrodipropanyloxybenzene.rgb)/2, (short) 82, MaterialIconSet.FINE, "C20H22N2O2");
    public static final SimpleDustMaterial AuPdCCatalyst = new SimpleDustMaterial("aupdc_catalyst", (Gold.materialRGB+Palladium.materialRGB+Carbon.materialRGB)/3, (short) 83, MaterialIconSet.SHINY, "AuPdC");
    public static final SimpleDustMaterial Cyanonaphthalene = new SimpleDustMaterial("cyanonaphthalene", (SodiumCyanide.rgb+ Naphthalene.materialRGB)/2, (short) 84, MaterialIconSet.FINE, "C11H7N");
    public static final SimpleDustMaterial TinChloride = new SimpleDustMaterial("tin_chloride", (Tin.materialRGB+Chlorine.materialRGB)/2, (short) 85, MaterialIconSet.ROUGH, "SnCl2");
    public static final SimpleDustMaterial Triphenylphosphine = new SimpleDustMaterial("triphenylphosphine", (Chlorobenzene.materialRGB+PhosphorusTrichloride.rgb)/2, (short) 86, MaterialIconSet.ROUGH, "(C6H5)3P");
    public static final SimpleDustMaterial Methylbenzophenanthrene = new SimpleDustMaterial("methylbenzophenanthrene", (Naphthaldehyde.rgb+EthylBenzene.materialRGB)/2, (short) 87, MaterialIconSet.FINE, "C19H14");
    ...
    public static final SimpleDustMaterial VanadiumSlagDust = new SimpleDustMaterial("vanadium_slag_dust", 0xf2ef1b, (short) 89, MaterialIconSet.ROUGH, "VO");
    public static final SimpleDustMaterial SodiumVanadate = new SimpleDustMaterial("sodium_vanadate", 0xf2df1d, (short) 90, MaterialIconSet.ROUGH, "Na3VO4");
    public static final SimpleDustMaterial AmmoniumVanadate = new SimpleDustMaterial("ammonium_vanadate", 0xf2ff1c, (short) 91, MaterialIconSet.FINE, "NH4VO3");
    public static final SimpleDustMaterial VanadiumOxide = new SimpleDustMaterial("vanadium_oxide", 0xf2ef1b, (short) 92, MaterialIconSet.FINE, "V2O5");
    public static final SimpleDustMaterial BariumSulfide = new SimpleDustMaterial("barium_sulfide", 0xc2c2be, (short) 93, MaterialIconSet.FINE, "BaS");
    ...
    public static final SimpleDustMaterial CaesiumHydroxide = new SimpleDustMaterial("caesium_hydroxide", Caesium.materialRGB-10, (short) 104, MaterialIconSet.ROUGH, "CsOH");
    public static final SimpleDustMaterial AluminiumHydroxide = new SimpleDustMaterial("aluminium_hydroxide", Aluminium.materialRGB-25, (short) 105, MaterialIconSet.FINE, "Al(OH)3");
    public static final SimpleDustMaterial PotassiumCarbonate = new SimpleDustMaterial("potassium_carbonate", (Potassium.materialRGB+Carbon.materialRGB+Oxygen.materialRGB)/3, (short) 106, MaterialIconSet.FINE, "K2CO3");
    public static final SimpleDustMaterial GrapheneOxidationResidue = new SimpleDustMaterial("graphene_oxidation_residue", 0x96821a, (short) 107, MaterialIconSet.FINE, "(KMnO4)(NaNO3)(H2SO4)");
    public static final SimpleDustMaterial NiAlOCatalyst = new SimpleDustMaterial("nialo_catalyst", 0x0af0af, (short) 108, MaterialIconSet.SHINY, "NiAl2O4");
    public static final SimpleDustMaterial FeCrOCatalyst = new SimpleDustMaterial("fecro_catalyst", 0x8C4517, (short) 109, MaterialIconSet.SHINY, "FeCrO3");
    ...
    public static final SimpleDustMaterial BariumHydroxide = new SimpleDustMaterial("barium_hydroxide", (Barium.materialRGB+Hydrogen.materialRGB+Oxygen.materialRGB)/3, (short) 117, MaterialIconSet.FINE, "Ba(OH)2");
    ...
    public static final SimpleDustMaterial SiliconChloride = new SimpleDustMaterial("silicon_chloride", Silicon.materialRGB-15, (short) 119, MaterialIconSet.ROUGH, "SiCl4");
    public static final SimpleDustMaterial HafniumChloride = new SimpleDustMaterial("hafnium_chloride", Hafnium.materialRGB+20, (short) 120, MaterialIconSet.FINE, "HfCl4");
    public static final SimpleDustMaterial ZincCokePellets = new SimpleDustMaterial("zinc_coke_pellets", (Zinc.materialRGB+Coke.materialRGB)/2, (short) 121, MaterialIconSet.ROUGH, "(H2O)(ZnS)C");
    ...
    public static final SimpleDustMaterial ZincFlueDust = new SimpleDustMaterial("zinc_flue_dust", 0xfcfca, (short) 123, MaterialIconSet.ROUGH, "?");
    ...
    public static final SimpleDustMaterial CadmiumZincDust = new SimpleDustMaterial("cadmium_zinc_dust", (Cadmium.materialRGB+Zinc.materialRGB)/2, (short) 127, MaterialIconSet.SHINY, "(H2SO4)CdZn?");
    public static final SimpleDustMaterial ThalliumResidue = new SimpleDustMaterial("thallium_residue", (Thallium.materialRGB-10), (short) 128, MaterialIconSet.SHINY, "Tl?");
    ...
    public static final SimpleDustMaterial ZincChloride = new SimpleDustMaterial("zinc_chloride", (Zinc.materialRGB+Chlorine.materialRGB)/2, (short) 130, MaterialIconSet.FINE, "ZnCl2");
    ...
    public static final SimpleDustMaterial SodiumSalts = new SimpleDustMaterial("sodium_salts", Sodium.materialRGB-5, (short) 138, MaterialIconSet.ROUGH, "NaCl?");
    public static final SimpleDustMaterial PotassiumMagnesiumSalts = new SimpleDustMaterial("kmg_salts", 0xcacac8, (short) 139, MaterialIconSet.ROUGH, "KClMg" + SULFATE.formula() + "K2" + SULFATE.formula() + "KF");
    public static final SimpleDustMaterial CalciumMagnesiumSalts = new SimpleDustMaterial("camg_salts", 0xcacac8, (short) 140, MaterialIconSet.ROUGH, "Ca" + CARBONATE.formula() + "(Sr" + CARBONATE.formula() + ")(CO2)MgO");
    public static final SimpleDustMaterial SodiumAluminiumHydride = new SimpleDustMaterial("sodium_aluminium_hydride", 0x98cafc, (short) 141, MaterialIconSet.ROUGH, "NaAlH4");
    public static final SimpleDustMaterial LithiumAluminiumHydride = new SimpleDustMaterial("lithium_aluminium_hydride", 0xc0defc, (short) 142, MaterialIconSet.ROUGH, "LiAlH4");
    public static final SimpleDustMaterial SodiumAzanide = new SimpleDustMaterial("sodium_azanide", (Sodium.materialRGB+Hydrogen.materialRGB+Nitrogen.materialRGB)/3, (short) 143, MaterialIconSet.FINE, "NaNH2");
    public static final SimpleDustMaterial SodiumAzide = new SimpleDustMaterial("sodium_azide", (Sodium.materialRGB+Nitrogen.materialRGB)/2, (short) 144, MaterialIconSet.FINE, "NaN3");
    public static final SimpleDustMaterial Glucosamine = new SimpleDustMaterial("glucosamine", (Cellulose.rgb+Water.materialRGB)/2, (short) 145, MaterialIconSet.FINE, "C6H13NO5");
    public static final SimpleDustMaterial AluminiumHydride = new SimpleDustMaterial("aluminium_hydride", 0x0b585c, (short) 146, MaterialIconSet.ROUGH, "AlH3");
    public static final SimpleDustMaterial SodiumHydride = new SimpleDustMaterial("sodium_hydride", 0xcacac8, (short) 147, MaterialIconSet.ROUGH, "NaH");
    ...
    public static final SimpleDustMaterial SodiumMolybdate = new SimpleDustMaterial("sodium_molybdate", 0xfcfc00, (short) 151, MaterialIconSet.ROUGH,"Na2MoO4");
    ...
    public static final SimpleDustMaterial Fructose = new SimpleDustMaterial("fructose", (Cellulose.rgb+Sugar.materialRGB)/2, (short) 165, MaterialIconSet.ROUGH, "C6H12O6");
    public static final SimpleDustMaterial Glucose = new SimpleDustMaterial("glucose", (Sugar.materialRGB+5), (short) 166, MaterialIconSet.ROUGH, "C6H12O6");
    public static final SimpleDustMaterial LeadNitrateCalciumMixture = new SimpleDustMaterial("lead_nitrate_calcium_mixture", (LeadNitrate.materialRGB+Calcium.materialRGB)/2, (short) 167, MaterialIconSet.SHINY, "(Pb(NO3)2)Ca9");
    //FREE ID 168
    public static final SimpleDustMaterial StrontiumOxide = new SimpleDustMaterial("strontium_oxide", 0xcacac8, (short) 169, MaterialIconSet.SHINY, "SrO");
    public static final SimpleDustMaterial Biphenyl = new SimpleDustMaterial("biphenyl", 0x003366, (short) 155, MaterialIconSet.SHINY, "C12H10");
    public static final SimpleDustMaterial Diiodobiphenyl = new SimpleDustMaterial("diiodobiphenyl", 0x000f66, (short) 156, MaterialIconSet.ROUGH, "C12H8I2");
    public static final SimpleDustMaterial Bipyridine = new SimpleDustMaterial("bipyridine", 0X978662, (short) 170, MaterialIconSet.FINE, "C10H8N2");
    public static final SimpleDustMaterial PalladiumChloride = new SimpleDustMaterial("palladium_chloride", 0xb9c0c7, (short) 157, MaterialIconSet.SHINY, "PdCl2");
    public static final SimpleDustMaterial PalladiumBisDibenzylidieneacetone = new SimpleDustMaterial("palladium_bisdibenzylidieneacetone", 0Xbe81a0, (short) 158, MaterialIconSet.ROUGH, "C51H42O3Pd2");
    public static final SimpleDustMaterial PotassiumTetrachloroplatinate = new SimpleDustMaterial("potassium_tetrachloroplatinate", 0xffba54, (short) 159, MaterialIconSet.SHINY, "K2PtCl4");
    ...
    public static final SimpleDustMaterial GrapheneNanotubeMix = new SimpleDustMaterial("graphene_nanotube_mix", 0x2c2c2c, (short) 162, MaterialIconSet.ROUGH, "(C)C?");
    ...
    public static final SimpleDustMaterial NiAlCatalyst = new SimpleDustMaterial("nial_catalyst", 0x6ea2ff, (short) 164, MaterialIconSet.SHINY, "NiAl");
    public static final SimpleDustMaterial TitaniumNitrate = new SimpleDustMaterial("titanium_nitrate", 0xFF0066, (short) 171, MaterialIconSet.FINE, "Ti" + NITRATE.formulaGroup(4));
    public static final SimpleDustMaterial SilverNitrate = new SimpleDustMaterial("silver_nitrate", 0xfdfdca, (short) 172, MaterialIconSet.SHINY, "AgNO3");
    ...
    public static final SimpleDustMaterial ManganeseSulfate = new SimpleDustMaterial("manganese_sulfate", (Manganese.materialRGB+Sulfur.materialRGB)/2, (short) 176, MaterialIconSet.ROUGH, "MnSO4");
    ...
    public static final SimpleDustMaterial NbTaContainingDust = new SimpleDustMaterial("nbta_containing_dust", 0xc8b9a9, (short) 178, MaterialIconSet.ROUGH, "NbTa");
    ...
    public static final SimpleDustMaterial FusedColumbite = new SimpleDustMaterial("fused_columbite", 0xCCCC00, (short) 180, MaterialIconSet.ROUGH, "(Fe2O3)(NaO)Nb2O5");
    ...
    public static final SimpleDustMaterial FusedTantalite = new SimpleDustMaterial("fused_tantalite", 0x915028, (short) 182, MaterialIconSet.ROUGH, "(Fe2O3)(NaO)Ta2O5");
    ...
    public static final SimpleDustMaterial ColumbiteMinorOxideResidue = new SimpleDustMaterial("columbite_minor_oxide_residue", 0x915028, (short) 184, MaterialIconSet.ROUGH, "(BaO)(SnO2)(WO3)(Al2O3)");
    public static final SimpleDustMaterial TantaliteMinorOxideResidue = new SimpleDustMaterial("tantalite_minor_oxide_residue", 0xCCCC00, (short) 185, MaterialIconSet.ROUGH, "(BaO)(ZrO2)(TiO2)(SiO2)");
    ...
    public static final SimpleDustMaterial BariumPeroxide = new SimpleDustMaterial("barium_peroxide", (Barium.materialRGB+Oxygen.materialRGB-30)/2, (short) 190, MaterialIconSet.SHINY, "BaO2");
    public static final SimpleDustMaterial CassiteriteCokePellets = new SimpleDustMaterial("cassiterite_coke_pellets", 0x8f8f8f, (short) 191, MaterialIconSet.ROUGH, "SnO2C?");
    public static final SimpleDustMaterial IronSulfateDust = new SimpleDustMaterial("iron_sulfate_dust", (Iron.materialRGB+Sulfur.materialRGB)/2, (short) 192, MaterialIconSet.SHINY, "FeSO4");
    public static final SimpleDustMaterial StrontiumCarbonate = new SimpleDustMaterial("strontium_carbonate", 0xcacac8, (short) 193, MaterialIconSet.ROUGH, "Sr" + CARBONATE.formula());
    public static final SimpleDustMaterial SodiumBicarbonate = new SimpleDustMaterial("sodium_bicarbonate", (Sodium.materialRGB+Hydrogen.materialRGB+Carbon.materialRGB)/3, (short) 194, MaterialIconSet.ROUGH, "NaHCO3");
    public static final SimpleDustMaterial SodiumHypochlorite = new SimpleDustMaterial("sodium_hypochlorite", 0x6cff50, (short) 195, MaterialIconSet.SHINY, "NaClO");
    ...
    public static final SimpleDustMaterial CopperGalliumIndiumMix = new SimpleDustMaterial("copper_gallium_indium_mix", (Indium.materialRGB + Copper.materialRGB + Gallium.materialRGB) / 3, (short) 198, MaterialIconSet.ROUGH, "CuGaIn");
    public static final SimpleDustMaterial CopperGalliumIndiumSelenide = new SimpleDustMaterial("copper_gallium_indium_selenide", (CopperGalliumIndiumMix.rgb + Selenium.materialRGB) / 2, (short) 199, MaterialIconSet.SHINY, "CuGaInSe2");
    public static final SimpleDustMaterial LanthanumCalciumManganate = new SimpleDustMaterial("lanthanum_gallium_manganate", 0x8aa07b, (short) 200, MaterialIconSet.SHINY, "LaCaMnO3");
    public static final SimpleDustMaterial AluminiumComplex = new SimpleDustMaterial("aluminium_complex", 0x3f5a9f, (short) 201, MaterialIconSet.SHINY, "AlC9H7NO");
    ...
    public static final SimpleDustMaterial WellMixedYBCOxides = new SimpleDustMaterial("well_mixed_ybc_oxides", 0x2c3429, (short) 208, MaterialIconSet.ROUGH, "YBa2Cu3O6");
    ...
    public static final SimpleDustMaterial IronIodide = new SimpleDustMaterial("iron_iodide", (Iron.materialRGB+Iodine.materialRGB)/2, (short) 214, MaterialIconSet.ROUGH, "FeI2");
    public static final SimpleDustMaterial PotassiumIodide = new SimpleDustMaterial("potassium_iodide", (Potassium.materialRGB+Iodine.materialRGB)/2, (short) 215, MaterialIconSet.ROUGH, "KI");
    public static final SimpleDustMaterial ThalliumIodide = new SimpleDustMaterial("thallium_iodide", (Thallium.materialRGB+Iodine.materialRGB)/2, (short) 216, MaterialIconSet.ROUGH, "TlI");
    public static final SimpleDustMaterial ScandiumIodide = new SimpleDustMaterial("scandium_iodide", (Scandium.materialRGB+Iodine.materialRGB)/2, (short) 217, MaterialIconSet.ROUGH, "ScI3");
    public static final SimpleDustMaterial RubidiumIodide = new SimpleDustMaterial("rubidium_iodide", (Rubidium.materialRGB+Iodine.materialRGB)/2, (short) 218, MaterialIconSet.ROUGH, "RbI");
    public static final SimpleDustMaterial IndiumIodide = new SimpleDustMaterial("indium_iodide", (Indium.materialRGB+Iodine.materialRGB)/2, (short) 219, MaterialIconSet.ROUGH, "InI3");
    public static final SimpleDustMaterial GalliumIodide = new SimpleDustMaterial("gallium_iodide", (Gallium.materialRGB+Iodine.materialRGB)/2, (short) 220, MaterialIconSet.ROUGH, "GaI3");
    public static final SimpleDustMaterial UVAHalideMix = new SimpleDustMaterial("uva_halide_mix", (GalliumIodide.rgb+PotassiumIodide.rgb+Mercury.materialRGB)/3, (short) 221, MaterialIconSet.SHINY, "Hg(GaI3)KI");
    public static final SimpleDustMaterial WhiteHalideMix = new SimpleDustMaterial("white_halide_mix", (ScandiumIodide.rgb+PotassiumIodide.rgb+Mercury.materialRGB)/3, (short) 222, MaterialIconSet.SHINY, "Hg(ScI3)KI");
    public static final SimpleDustMaterial BlueHalideMix = new SimpleDustMaterial("blue_halide_mix", (IndiumIodide.rgb+PotassiumIodide.rgb+Mercury.materialRGB)/3, (short) 223, MaterialIconSet.SHINY, "Hg(InI3)KI");
    public static final SimpleDustMaterial GreenHalideMix = new SimpleDustMaterial("green_halide_mix", (ThalliumIodide.rgb+PotassiumIodide.rgb+Mercury.materialRGB)/3, (short) 224, MaterialIconSet.SHINY, "Hg(TlI)KI");
    public static final SimpleDustMaterial RedHalideMix = new SimpleDustMaterial("red_halide_mix", (RubidiumIodide.rgb+PotassiumIodide.rgb+Mercury.materialRGB)/3, (short) 225, MaterialIconSet.SHINY, "Hg(RbI)KI");
    ...
    public static final SimpleDustMaterial BoronFranciumCarbide = new SimpleDustMaterial("boron_francium_carbide", 0x808080, (short) 234, MaterialIconSet.SHINY, "Fr4B4C7");
    ...
    public static final SimpleDustMaterial SodiumIodide = new SimpleDustMaterial("sodium_iodide", 0x555588, (short) 236, MaterialIconSet.ROUGH, "NaI");
    public static final SimpleDustMaterial SodiumIodate = new SimpleDustMaterial("sodium_iodate", 0x11116d, (short) 237, MaterialIconSet.ROUGH, "NaIO3");
    public static final SimpleDustMaterial SodiumPeriodate = new SimpleDustMaterial("sodium_periodate", 0x11116d, (short) 238, MaterialIconSet.SHINY, "NaIO4");
    public static final SimpleDustMaterial SodiumSeaborgate = new SimpleDustMaterial("sodium_seaborgate", 0x55bbd4, (short) 239, MaterialIconSet.SHINY, "Na2SgO4");
    ...
    public static final SimpleDustMaterial YttriumEuropiumVanadate = new SimpleDustMaterial("yttrium_europium_vanadate", (Yttrium.materialRGB+ Europium.materialRGB+Vanadium.materialRGB)/3, (short) 242, MaterialIconSet.SHINY, "YEuVO4");
    public static final SimpleDustMaterial StrontiumEuropiumAluminate = new SimpleDustMaterial("strontium_europium_aluminate", (Strontium.materialRGB+ Europium.materialRGB+Aluminium.materialRGB)/3, (short) 243, MaterialIconSet.SHINY, "SrEuAl2O4");
    ...
    public static final SimpleDustMaterial BariumChloride = new SimpleDustMaterial("barium_chloride", (Barium.materialRGB+Chlorine.materialRGB)/2, (short) 247, MaterialIconSet.SHINY, "BaCl2");
    ...
    public static final SimpleDustMaterial ZirconylChloride = new SimpleDustMaterial("zirconyl_chloride", ZirconiumTetrachloride.rgb, (short) 249, MaterialIconSet.SHINY, "ZrOCl2");
    public static final SimpleDustMaterial LeadSenenide = new SimpleDustMaterial("lead_selenide", (Lead.materialRGB+Selenium.materialRGB)/2, (short) 250, MaterialIconSet.ROUGH, "PbSe");
    ...
    public static final SimpleDustMaterial MagnetorestrictiveAlloy = new SimpleDustMaterial("magnetorestrictive_alloy", 0xafefef, (short) 252, MaterialIconSet.ROUGH, "Tb4Dy7Fe10Co5B2SiC");
    public static final SimpleDustMaterial BoronOxide = new SimpleDustMaterial("boron_oxide",(Boron.materialRGB+Oxygen.materialRGB)/2,(short) 256,MaterialIconSet.ROUGH, "B2O3");
    public static final SimpleDustMaterial LithiumAluminiumFluoride = new SimpleDustMaterial("lithium_aluminium_fluoride",(Lithium.materialRGB+Aluminium.materialRGB+Fluorine.materialRGB)/3,(short) 263,MaterialIconSet.ROUGH, "AlF4Li");
    ...
    public static final SimpleDustMaterial CopperArsenite = new SimpleDustMaterial("copper_arsenite",0x66ff66,(short) 287,MaterialIconSet.ROUGH, "Cu3(AsO4)2");
    ...
    public static final SimpleDustMaterial TitaniumYellow = new SimpleDustMaterial("titanium_yellow",0xffff00,(short) 289,MaterialIconSet.SHINY, "NiO(Sb2O3)(TiO2)20");
    public static final SimpleDustMaterial CobaltZincOxide = new SimpleDustMaterial("cobalt_zinc_oxide",0x00ffff,(short) 290,MaterialIconSet.SHINY, "CoZn4O5");
    ...
    public static final SimpleDustMaterial CobaltAluminate = new SimpleDustMaterial("cobalt_aluminate",0x0000ff,(short) 292,MaterialIconSet.FINE, "Al2Co2O5");
    public static final SimpleDustMaterial PotassiumFerrocyanide = new SimpleDustMaterial("potassium_ferrocyanide",0x0000ff,(short) 293,MaterialIconSet.ROUGH, "K4Fe(CN)6(H2O)3");
    ...
    public static final SimpleDustMaterial AmmoniumManganesePhosphate = new SimpleDustMaterial("ammonium_manganese_phosphate",0x660066,(short) 295,MaterialIconSet.SHINY, "NH4MnPO4");
    ...
    public static final SimpleDustMaterial Nigrosin = new SimpleDustMaterial("nigrosin",0x000000,(short) 300,MaterialIconSet.DULL, "C36H26N5ClNa2S2O6");
    ...
    public static final SimpleDustMaterial Diketopyrrolopyrrole = new SimpleDustMaterial("diketopyrrolopyrrole",0xff6600,(short) 308,MaterialIconSet.DULL, "C18H12N2O2");
    ...
    public static final SimpleDustMaterial MercuryChloride = new SimpleDustMaterial("mercury_chloride",0xd6b8ad,(short) 316,MaterialIconSet.ROUGH, "HgCl2");
    public static final SimpleDustMaterial SodiumSulfanilate = new SimpleDustMaterial("sodium_sulfanilate",0xe49879,(short) 317,MaterialIconSet.SHINY, "C6H6NNaO3S");
    public static final SimpleDustMaterial Anthraquinone = new SimpleDustMaterial("anthraquinone",0xfff782,(short) 320,MaterialIconSet.ROUGH, "C14H8O2");
    public static final SimpleDustMaterial LithiumHydride = new SimpleDustMaterial("lithium_hydride",(Lithium.materialRGB+Hydrogen.materialRGB)/2,(short) 321,MaterialIconSet.ROUGH, "LiH");
    public static final SimpleDustMaterial NiobiumChloride = new SimpleDustMaterial("niobium_chloride",Niobium.materialRGB,(short) 322, MaterialIconSet.SHINY, "NbCl5");
    public static final SimpleDustMaterial NiobiumHydroxide = new SimpleDustMaterial("niobium_hydroxide",0x7c7c7c,(short) 323,MaterialIconSet.ROUGH, "Nb(OH)5");
    public static final SimpleDustMaterial MagnesiumFluoride = new SimpleDustMaterial("magnesium_fluoride",0xcfcfcf,(short) 324,MaterialIconSet.SHINY, "MgF2");
    public static final SimpleDustMaterial ZincSulfide = new SimpleDustMaterial("zinc_sulfide",0x3c3c3c,(short) 325,MaterialIconSet.FINE, "ZnS");
    public static final SimpleDustMaterial LithiumNiobateNanoparticles = new SimpleDustMaterial("lithium_niobate_nanoparticles",LithiumNiobate.materialRGB-10,(short) 326,MaterialIconSet.SHINY, "LiNbO4");
    ...
    public static final SimpleDustMaterial FranciumCaesiumCadmiumBromide = new SimpleDustMaterial("francium_caesium_cadmium_bromide",(Francium.materialRGB+Caesium.materialRGB+Cadmium.materialRGB+Bromine.materialRGB)/4,(short) 330,MaterialIconSet.SHINY, "FrCsCf2Br6");
    public static final SimpleDustMaterial ZincSelenide = new SimpleDustMaterial("zinc_selenide",0xfcfc00,(short) 331,MaterialIconSet.FINE, "ZnSe");
    public static final SimpleDustMaterial RhodamineB = new SimpleDustMaterial("rhodamine_b",0xfc2020,(short) 332,MaterialIconSet.SHINY, "C28H31ClN2O3");
    public static final SimpleDustMaterial Stilbene = new SimpleDustMaterial("stilbene",0x3c9c3c,(short) 333,MaterialIconSet.SHINY, "C14H12");
    ...
    public static final SimpleDustMaterial DitertbutylDicarbonate = new SimpleDustMaterial("ditertbutyl_dicarbonate",0xccccf6,(short) 335, MaterialIconSet.ROUGH, "C10H18O5");
    public static final SimpleDustMaterial PotassiumBromide = new SimpleDustMaterial("potassium_bromide",0xe066a3,(short) 336,MaterialIconSet.FINE, "KBr");
    public static final SimpleDustMaterial PotassiumBromate = new SimpleDustMaterial("potassium_bromate",0x8a4cd1,(short) 337,MaterialIconSet.ROUGH, "KBrO3");
    public static final SimpleDustMaterial IBX = new SimpleDustMaterial("ibx",0x20208c,(short) 338,MaterialIconSet.SHINY, "C7H5IO4");
    ...
    public static final SimpleDustMaterial PotassiumNonahydridotechnetate = new SimpleDustMaterial("potassium_nonahydridotechnetate",0xede2a4,(short) 342,MaterialIconSet.SHINY, "H9K2TcO4");
    public static final SimpleDustMaterial PotassiumNonahydridorhenate = new SimpleDustMaterial("potassium_nonahydridorhenate",0xeae2a8,(short) 343,MaterialIconSet.SHINY, "H9K2ReO4");
    public static final SimpleDustMaterial LithiumIodide = new SimpleDustMaterial("lithium_iodide",(Lithium.materialRGB+Iodine.materialRGB),(short) 344,MaterialIconSet.ROUGH, "LiI");
    public static final SimpleDustMaterial PalladiumLoadedRutileNanoparticles = new SimpleDustMaterial("palladium_loaded_rutile_nanoparticles",(Palladium.materialRGB+Rutile.materialRGB),(short) 345,MaterialIconSet.FINE, "PdTiO2");
    public static final SimpleDustMaterial SaccharicAcid = new SimpleDustMaterial("saccharic_acid",Glucose.rgb,(short) 346,MaterialIconSet.METALLIC, "C6H10O8");
    public static final SimpleDustMaterial AdipicAcid = new SimpleDustMaterial("adipic_acid",0xda9288,(short) 347,MaterialIconSet.ROUGH, "C6H10O4");
    public static final SimpleDustMaterial TetraethylammoniumNonahydridides = new SimpleDustMaterial("tetraethylammonium_nonahydrides",0xbee8b9,(short) 348,MaterialIconSet.SHINY, "(C8H20N)(ReH9)(TcH9)");
    ...
    public static final SimpleDustMaterial MercuryAcetate = new SimpleDustMaterial("mercury_acetate",0xcc8562, (short) 369, MaterialIconSet.ROUGH, "Hg(CH3COO)2");
    public static final SimpleDustMaterial CalciumCyanamide = new SimpleDustMaterial("calcium_cyanamide", CalciumCarbide.rgb, (short) 370, MaterialIconSet.SHINY, "CaCN2");
    public static final SimpleDustMaterial SelectivelyMutatedCupriavidiusNecator = new SimpleDustMaterial("selectively_mutated_cupriavidius_necator", CupriavidusNecator.rgb * 5 / 4, (short) 373, MaterialIconSet.SHINY, "Bacteria");
    public static final SimpleDustMaterial PurifiedColumbite = new SimpleDustMaterial("purified_columbite", LeachedColumbite.rgb, (short) 371, MaterialIconSet.SHINY, "Ta2O5Nb18O45");
    public static final SimpleDustMaterial PurifiedPyrochlore = new SimpleDustMaterial("purified_pyrochlore", LeachedPyrochlore.rgb, (short) 372, MaterialIconSet.SHINY, "Ta2O5Nb18O45");
    ...
    public static final SimpleDustMaterial LithiumCobaltOxide = new SimpleDustMaterial("lithium_cobalt_oxide",0xd2a4f3,(short) 387, MaterialIconSet.SHINY, "LiCoO");
    public static final SimpleDustMaterial LithiumTriflate = new SimpleDustMaterial("lithium_triflate",0xe2dae3, (short) 388, MaterialIconSet.SHINY, "LiCSO3F3");
    public static final SimpleDustMaterial Xylose = new SimpleDustMaterial("xylose", Glucose.rgb,(short) 389, MaterialIconSet.ROUGH, "C5H10O5");
    ...
    public static final SimpleDustMaterial Halloysite = new SimpleDustMaterial("halloysite", 0x23423a, (short) 391, MaterialIconSet.ROUGH, "Al9Si10O50Ga");
    public static final SimpleDustMaterial GalliumChloride = new SimpleDustMaterial("gallium_chloride", 0x92867a, (short) 392, MaterialIconSet.ROUGH, "GaCl3");
    public static final SimpleDustMaterial SulfurCoatedHalloysite = new SimpleDustMaterial("sulfur_coated_halloysite", 0x23973a, (short) 393, MaterialIconSet.ROUGH, "S2C2(Al9Si10O50Ga)");
    ...
    public static final SimpleDustMaterial CalciumAlginate = new SimpleDustMaterial("calcium_alginate",0x654321, (short) 397, MaterialIconSet.ROUGH, "CaC12H14O12");
    public static final SimpleDustMaterial NickelOxideHydroxide = new SimpleDustMaterial("nickel_oxide_hydroxide",0xa2f2a2,(short) 398, MaterialIconSet.METALLIC, "NiO(OH)");
    ...
    public static final SimpleDustMaterial BorocarbideDust = new SimpleDustMaterial("borocarbide_dust", 0x9a9a2a, (short) 258, MaterialIconSet.SHINY, "B4C7Fr4At6Ho2Th2Fl2Cn2");
    ...
    public static final SimpleDustMaterial StrontiumSuperconductorDust = new SimpleDustMaterial("strontium_superconductor_dust", 0x45abf4, (short) 260, MaterialIconSet.SHINY, "Sr2RuSgO8");
    ...
    public static final SimpleDustMaterial SodiumMetavanadate = new SimpleDustMaterial("sodium_metavanadate", SodaAsh.materialRGB,(short) 262, MaterialIconSet.FINE, "NaVO3");
    public static final SimpleDustMaterial PotassiumPeroxymonosulfate = new SimpleDustMaterial("potassium_peroxymonosulfate", (PotassiumMetabisulfite.materialRGB + 20), (short) 374, MaterialIconSet.FINE, "KHSO5");
    public static final SimpleDustMaterial CoAcABCatalyst = new SimpleDustMaterial("coacab_catalyst", 0x755f30, (short) 900, MaterialIconSet.FINE, "Co/AC-AB");
    public static final SimpleDustMaterial SilverPerchlorate = new SimpleDustMaterial("silver_perchlorate", SilverChloride.materialRGB, (short) 902, MaterialIconSet.SHINY, "AgClO4");
    public static final SimpleDustMaterial SodiumChlorate = new SimpleDustMaterial("sodium_chlorate", Salt.materialRGB, (short) 901, MaterialIconSet.ROUGH, "NaClO3");
    ...
    public static final SimpleDustMaterial PotassiumHydroxylaminedisulfonate = new SimpleDustMaterial("potassium_hydroxylaminedisulfonate", (0xF0EAD6 + NitrousAcid.rgb)/2, (short) 910, MaterialIconSet.DULL, "KHSO3");
    public static final SimpleDustMaterial SuccinicAnhydride = new SimpleDustMaterial("succinic_anhydride", (SuccinicAcid.rgb + AceticAnhydride.rgb)/2, (short) 911, MaterialIconSet.DULL, "(CH2CO)2O");
    public static final SimpleDustMaterial AmmoniumAcetate = new SimpleDustMaterial("ammonium_acetate", 0xb6dee0, (short) 912, MaterialIconSet.DULL, "NH4CH3CO2");
    public static final SimpleDustMaterial Acetamide = new SimpleDustMaterial("acetamide", 0xa6bebf, (short) 913, MaterialIconSet.DULL, "CH3CONH2");
    public static final SimpleDustMaterial Acetonitrile = new SimpleDustMaterial("acetonitrile", 0xa2afb0, (short) 914, MaterialIconSet.DULL, "CH3CN");
    public static final SimpleDustMaterial NHydroxysuccinimide = new SimpleDustMaterial("n-hydroxysuccinimide", 0xdbcae3, (short) 915, MaterialIconSet.DULL, "(CH2CO)2NOH");
    ...
    public static final SimpleDustMaterial SodiumBorohydride = new SimpleDustMaterial("sodium_borohydride", 0xc2c2fa, (short) 929, MaterialIconSet.ROUGH, "NaBH4");
    public static final SimpleDustMaterial SodiumTetrafluoroborate = new SimpleDustMaterial("sodium_tetrafluoroborate", (SodiumBorohydride.rgb+Fluorine.materialRGB)/2, (short) 930, MaterialIconSet.DULL, "NaBF4");
    public static final SimpleDustMaterial Decaborane = new SimpleDustMaterial("decaborane", Diborane.rgb, (short) 931, MaterialIconSet.DULL, "B10H14");
    public static final SimpleDustMaterial CesiumCarboranePrecusor = new SimpleDustMaterial("cesium_carborane_precursor", 0xb56487, (short) 932, MaterialIconSet.ROUGH, "CsB10H12CN(CH3)3Cl");
    public static final SimpleDustMaterial CesiumCarborane = new SimpleDustMaterial("cesium_carborane", CesiumCarboranePrecusor.rgb*6/5, (short) 933, MaterialIconSet.DULL, "CsCB11H12");
    public static final SimpleDustMaterial Fluorocarborane = new SimpleDustMaterial("fluorocarborane", 0x20EB7A, (short) 934, MaterialIconSet.SHINY, "HCHB11F11");
    public static final SimpleDustMaterial CaesiumNitrate = new SimpleDustMaterial("caesium_nitrate", 0x7452DC, (short) 935, MaterialIconSet.ROUGH, "CsNO3");
    public static final SimpleDustMaterial SilverIodide = new SimpleDustMaterial("silver_iodide", (SilverChloride.materialRGB*2+Iodine.materialRGB)/3, (short) 936, MaterialIconSet.ROUGH, "AgI");
    public static final SimpleDustMaterial ActiniumTriniumHydroxides = new SimpleDustMaterial("actinium_trinium_hydroxides", (ActiniumOxalate.rgb+Trinium.materialRGB)/2, (short) 937, MaterialIconSet.ROUGH, "Ke3Ac2(OH)12");
    public static final SimpleDustMaterial TriniumTetrafluoride = new SimpleDustMaterial("trinium_tetrafluoride", 0x477347, (short) 938, MaterialIconSet.SHINY, "KeF4");
    public static final SimpleDustMaterial ActiniumNitrate = new SimpleDustMaterial("actinium_nitrate", YttriumNitrate.rgb, (short) 939, MaterialIconSet.ROUGH, "Ac(NO3)3");
    public static final SimpleDustMaterial RadiumNitrate = new SimpleDustMaterial("radium_nitrate", BariumNitrate.rgb, (short) 940, MaterialIconSet.DULL, "Ra(NO3)2");
    ...
    public static final SimpleDustMaterial PartiallyOxidizedResidues = new SimpleDustMaterial("partially_oxidized_residues", StoneResidueDust.rgb+Dioxygendifluoride.rgb, (short) 952, MaterialIconSet.DULL);
    ...
    public static final SimpleDustMaterial OxidizedResidues = new SimpleDustMaterial("oxidized_residues", (DiamagneticResidues.rgb+ParamagneticResidues.rgb+ FerromagneticResidues.rgb+0x9f0000)/4, (short) 955, MaterialIconSet.DULL);
    public static final SimpleDustMaterial HeavyOxidizedResidues = new SimpleDustMaterial("heavy_oxidized_residues", (DiamagneticResidues.rgb+ParamagneticResidues.rgb+ FerromagneticResidues.rgb+0x9f0000)/4, (short) 956, MaterialIconSet.DULL);
    ...
    public static final SimpleDustMaterial IridiumCyclooctadienylChlorideDimer = new SimpleDustMaterial("iridium_cyclooctadienyl_chloride_dimer", (Dichlorocycloctadieneplatinium.rgb+Iridium.materialRGB)/2, (short) 943, MaterialIconSet.SHINY, "Ir2(C8H12)2Cl2");
    public static final SimpleDustMaterial FinelyPowderedRutile = new SimpleDustMaterial("finely_powdered_rutile", 0xffffff, (short) 959, MaterialIconSet.FINE, "TiO2");
    public static final SimpleDustMaterial InertResidues = new SimpleDustMaterial("inert_residues", 0x61587a, (short) 960, MaterialIconSet.SHINY);


    public static final IngotMaterial SamariumMagnetic = new IngotMaterial(977, "samarium_magnetic", 16777215, MaterialIconSet.MAGNETIC, 2, ImmutableList.of(new MaterialStack(Samarium, 1L)), EXT2_METAL | gregtech.api.unification.material.type.SolidMaterial.MatFlags.GENERATE_LONG_ROD, (Element)null, 1347);
    public static final IngotMaterial Quantum = new IngotMaterial(857, "quantum", 0x0f0f0f, MaterialIconSet.SHINY, 7, of(new MaterialStack(Stellite, 15), new MaterialStack(Jasper, 5), new MaterialStack(Gallium, 5), new MaterialStack(Americium241.getMaterial(), 5), new MaterialStack(Palladium, 5), new MaterialStack(Bismuth, 5), new MaterialStack(Germanium, 5), new SimpleDustMaterialStack(SiliconCarbide, 5)), CORE_METAL | DISABLE_DECOMPOSITION | DISABLE_REPLICATION | DISABLE_AUTOGENERATED_MIXER_RECIPE, null, 11400);
    ...
    public void onMaterialsInit() {
        ...
        RedSteel.addFlag(GENERATE_FRAME);
        Thorium.addFlag(GENERATE_FRAME);
        Americium.addFlag(GENERATE_FRAME);
        Iron.addFlag(GENERATE_FRAME);
        Lead.addFlag(GENERATE_FRAME);
        HSSG.addFlag(GENERATE_FRAME);
