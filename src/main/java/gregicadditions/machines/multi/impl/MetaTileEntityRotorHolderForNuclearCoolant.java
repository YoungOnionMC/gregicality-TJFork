...
public class MetaTileEntityRotorHolderForNuclearCoolant extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<MetaTileEntityRotorHolderForNuclearCoolant> {
    ...
    public MetaTileEntityRotorHolderForNuclearCoolant(ResourceLocation metaTileEntityId, int tier, int maxSpeed) {
    ...
    public MetaTileEntityRotorHolderForNuclearCoolant(ResourceLocation metaTileEntityId, int tier, float speedMultiplier) {
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new MetaTileEntityRotorHolderForNuclearCoolant(metaTileEntityId, getTier(), maxRotorSpeed);
    }
    ...
    public void update() {
        ...
        MetaTileEntityHotCoolantTurbine controller = (MetaTileEntityHotCoolantTurbine) getController();
    ...
    @Override
    public MultiblockAbility<MetaTileEntityRotorHolderForNuclearCoolant> getAbility() {
        return MetaTileEntityHotCoolantTurbine.ABILITY_ROTOR_HOLDER;
    }

    @Override
    public void registerAbilities(List<MetaTileEntityRotorHolderForNuclearCoolant> abilityList) {
