...
public class GAMetaBlocks {
    ...
    public static void init() {
        ...
        enabledMaterials.remove(NaquadriaticTaranium);
        enabledMaterials.remove(Neutronium);
        enabledMaterials.remove(CosmicNeutronium);
        ...
        GA_CABLE.addCableMaterial(NaquadriaticTaranium, new WireProperties(GAValues.V[GAValues.UMV], 2, 32));
        GA_CABLE.addCableMaterial(Neutronium, new WireProperties(GAValues.V[GAValues.UXV], 2, 32));
        GA_CABLE.addCableMaterial(CosmicNeutronium, new WireProperties(GAValues.V[GAValues.MAX], 32, 32));
