    ...
    public static ImmutableMap<String, MultiblockInfoRecipeWrapper> getRecipes() {
        if(multiblockRecipes == null) {
            multiblockRecipes = new ImmutableMap.Builder<String, MultiblockInfoRecipeWrapper>()
                    ...
                    .put("large_miner_1", new MultiblockInfoRecipeWrapper(new LargeMinerInfo(GATileEntities.BASIC_LARGE_MINER)))
                    .put("large_miner_2", new MultiblockInfoRecipeWrapper(new LargeMinerInfo(GATileEntities.LARGE_MINER)))
                    .put("large_miner_3", new MultiblockInfoRecipeWrapper(new LargeMinerInfo(GATileEntities.ADVANCED_LARGE_MINER)))
                    .put("large_miner_4", new MultiblockInfoRecipeWrapper(new LargeMinerInfo(GATileEntities.CREATIVE_LARGE_MINER)))
