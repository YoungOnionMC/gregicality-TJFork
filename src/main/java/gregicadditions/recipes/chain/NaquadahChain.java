...
public class NaquadahChain {
    ...
    public static void init() {
        ...
        DISTILLATION_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(ComplicatedNaquadahGas.getFluid(100))
                .fluidOutputs(ComplicatedLightNaquadah.getFluid(180))
                .fluidOutputs(ComplicatedMediumNaquadah.getFluid(300))
                .fluidOutputs(ComplicatedHeavyNaquadah.getFluid(420))
                .EUt(7680)
                .duration(500)
                .buildAndRegister();
        ...
        DISTILLATION_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(NaquadahGas.getFluid(400))
                ...
                .fluidOutputs(Fluorine.getFluid(200))
                .EUt(7680)
                .duration(200)
                .buildAndRegister();
        ...
        DISTILLATION_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(NaquadahGas.getFluid(300))
                ...
                .fluidOutputs(Fluorine.getFluid(400))
                .EUt(7680)
                .duration(200)
                .buildAndRegister();
        ...
        DISTILLATION_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(Fluorine.getFluid(600))
                .EUt(7680)
                .duration(200)
                .buildAndRegister();
        ...
        DISTILLATION_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(ComplicatedHeavyENaquadah.getFluid(400))
                .EUt(7680)
                .duration(500)
                .buildAndRegister();
        ...
        DISTILLATION_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(NaquadahGas.getFluid(500))
                .fluidOutputs(LightENaquadahFuel.getFluid(400))
                .fluidOutputs(MediumENaquadahFuel.getFluid(170))
                .fluidOutputs(HeavyENaquadahFuel.getFluid(100))
                .fluidOutputs(Radon.getFluid(200))
                .EUt(7680)
                .duration(200)
                .buildAndRegister();
        ...
        DISTILLATION_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(HeavyENaquadahFuel.getFluid(100))
                .fluidOutputs(Radon.getFluid(400))
                .EUt(7680)
                .duration(200)
                .buildAndRegister();
