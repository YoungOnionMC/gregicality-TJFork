...
import static gregicadditions.recipes.helper.HelperMethods.removeTieredRecipeByName;
...
public class MachineCraftingRecipes {
    ...
    private static void hullOverride() {
        ...
        ModHandler.addShapedRecipe("ga_hull_umv", GATileEntities.GA_HULLS[3].getStackForm(), "PHP", "CMC", 'M', GAMetaBlocks.MACHINE_CASING.getItemVariant(GAMachineCasing.CasingType.CASING_UMV),  'C', new UnificationEntry(cableGtQuadruple, NaquadriaticTaranium), 'H', new UnificationEntry(plate, BlackTitanium),    'P', new UnificationEntry(plate, FullerenePolymerMatrix));
        ...
        ASSEMBLER_RECIPES.recipeBuilder().EUt(16).duration(50).inputs(GAMetaBlocks.MACHINE_CASING.getItemVariant(GAMachineCasing.CasingType.CASING_UMV)).input(cableGtQuadruple, NaquadriaticTaranium, 2)            .fluidInputs(FullerenePolymerMatrix.getFluid(L * 2)).outputs(GATileEntities.GA_HULLS[3].getStackForm()).buildAndRegister();
        ...
        ModHandler.addShapedRecipe("ga_casing_umv", GAMetaBlocks.MACHINE_CASING.getItemVariant(GAMachineCasing.CasingType.CASING_UMV),  "PPP", "PwP", "PPP", 'P', new UnificationEntry(plate, BlackTitanium));
        ...
        ASSEMBLER_RECIPES.recipeBuilder().EUt(16).duration(50).circuitMeta(8).input(plate, BlackTitanium, 8)   .outputs(GAMetaBlocks.MACHINE_CASING.getItemVariant(GAMachineCasing.CasingType.CASING_UMV)).buildAndRegister();
