...
public class CircuitRecipes {
    ...
    private static void cosmicCircuits() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(100).EUt(30_720_000).qubit(4)
                ...
                .inputs(SMD_CAPACITOR_COSMIC.getStackForm(16))
                .inputs(SMD_TRANSISTOR_COSMIC.getStackForm(16))
                .inputs(SMD_DIODE_COSMIC.getStackForm(16))
                .inputs(SMD_RESISTOR_COSMIC.getStackForm(16))
    ...
    private static void supracausalCircuits() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(50).EUt(122_880_000).qubit(8)
                ...
                .input(wireGtSingle, UMVSuperconductor, 8)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(100).EUt(491_520_000).qubit(8)
                ...
                .inputs(COSMIC_PROCESSING_UNIT_CORE.getStackForm(32))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(100).EUt(Integer.MAX_VALUE).qubit(16)
                ...
                .inputs(PHOTOCOATED_HASSIUM_WAFER.getStackForm(32))
