...
public class CircuitRecipes {
    ...
    private static void exoticCircuits() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(200).EUt((int)4E+6).qubit(2)
                ...
                .input(wireGtSingle, UHVSuperconductor, 2)
                .fluidInputs(EnrichedNaquadahAlloy.getFluid(L))
                .fluidInputs(TriniumTitanium.getFluid(L))
                .fluidInputs(Quantum.getFluid(L))
    ...
    private static void cosmicCircuits() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(100).EUt(30_720_000).qubit(4)
                ...
                .input(foil, Zylon, 16)
                .fluidInputs(Tritanium.getFluid(L))
                .fluidInputs(Polyetheretherketone.getFluid(L * 3))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(200).EUt(30_720_000).qubit(8)
                ...
                .inputs(SMD_DIODE_COSMIC.getStackForm(64))
                .inputs(SMD_RESISTOR_COSMIC.getStackForm(64))
                .input(wireGtSingle, UIVSuperconductor, 12)
                .inputs(UHASOC.getStackForm(64))
                .inputs(UHPIC.getStackForm(64))
                ...
                .fluidInputs(TriniumTitanium.getFluid(L * 2))
    ...
    private static void supracausalCircuits() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(50).EUt(122_880_000).qubit(8)
                ...
                .fluidInputs(ProtoAdamantium.getFluid(L * 2))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(100).EUt(491_520_000).qubit(8)
                ...
                .fluidInputs(Taranium.getFluid(L * 2))
                .fluidInputs(TriniumTitanium.getFluid(L * 2))
                .fluidInputs(ProtoAdamantium.getFluid(L))
                .fluidInputs(FullerenePolymerMatrix.getFluid(L * 2))
