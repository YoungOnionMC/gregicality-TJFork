...
public class GARecipeMapCategory implements IRecipeCategory<GARecipeWrapper> {
    ...
    public GARecipeMapCategory(RecipeMap<?> recipeMap, IGuiHelper guiHelper) {
    ...
    public String getUid() {
        return Gregicality.MODID + ":" + recipeMap.unlocalizedName;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, GARecipeWrapper recipeWrapper, IIngredients ingredients) {
